  ...
  return (
    ...
    "Indeed, to Allah we belong and to Him we shall return." (Qur’an 2:156)
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <button onClick={handleSubscribe} className=" cursor-pointer bg-white text-slate-800 px-6 py-3 rounded-md font-medium hover:bg-slate-100 transition">
           {msg ?msg: "Get Notified"}
          </button>
          <Link  className=" cursor-pointer border   border-white text-white px-6 py-3 rounded-md font-medium hover:bg-slate-800 transition w-full h-10 flex justify-center items-center">
           LEARN MORE
          </Link>
        </div>
      </div>
